def show(day, month, name='user'):

    if day > 31 or month > 12 or type(name) == int:
        return "НЕ Верно вили данные"
    ...
    elif (day >= 22 and month == 12) or min(day <= 19 and day <= 19,  month == 1):
        return name, 'Козерог'
